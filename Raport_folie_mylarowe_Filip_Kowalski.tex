...
\hline
\begin{tabular}[c]{@{}c@{}}Numer  \\ {{próbki}}\end{tabular} & \begin{tabular}[c]{@{}c@{}}Numer \\ {{kanału}}\end{tabular} & \begin{tabular}[c]{@{}c@{}}Energia po przejściu \\ {{ przez próbkę [}Mev{]}}\end{tabular}&\begin{tabular}[c]{@{}c@{}}Grubość  \\ {{próbki[}$\mu m${]}}\end{tabular}  \\ \hline

A:  &   2433.  &  5080   &  ${3.553}\pm{0.0080}$   \\\hline    
 B:  &   2579   &  5386   &  ${0.8964}\pm{0.0084}$   \\\hline    
 B2:  &   2579   &  5388   &  ${0.8781}\pm{0.0072}$   \\\hline    
 C:  &   2532   &  5287   &  ${1.767}\pm{0.0063}$   \\\hline    
 D:  &   2533   &  5293   &  ${1.717}\pm{0.011}$   \\\hline    
 E:  &   2359   &  4926   &  ${4.851}\pm{0.011}$   \\\hline    
 F:  &   2438   &  5094   &  ${3.440}\pm{0.012}$   \\\hline    
 G:  &   2446   &  5111   &  ${3.294}\pm{0.011}$   \\\hline    
 H:  &   2443   &  5105   &  ${3.342}\pm{0.011}$   \\\hline    
